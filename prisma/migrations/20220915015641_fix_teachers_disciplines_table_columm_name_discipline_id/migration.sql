/*
  ...
  - You are about to drop the column `diciplineId` on the `teachersDisciplines` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "teachersDisciplines" DROP CONSTRAINT "teachersDisciplines_diciplineId_fkey";

-- AlterTable
ALTER TABLE "teachersDisciplines" DROP COLUMN "diciplineId",
